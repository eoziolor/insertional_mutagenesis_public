...
---
title: "2.1.bam_processing_new.Rmd"
author: "Elias Oziolor"
date: "12/8/2021"
output: html_document
---
...
loadIS <- function(meta,
  ...
  for(i in files){
    ...
    if(!is.null(read.info) & dim(read.info)[1]>0){
